...
class EditBrandContactsPageView extends StatelessWidget {
  const EditBrandContactsPageView({super.key});
  ...
  Widget _buildContacts(BuildContext context) {
    return Observer(
      builder: (context) {
        ...
        if (state.brand.contacts.isEmpty) {
        ...
        return ListView.separated(
          ...
          itemBuilder: (context, index) {
            final Contact contact = state.brand.contacts.elementAt(index);
          ...
          itemCount: state.brand.contacts.length,
