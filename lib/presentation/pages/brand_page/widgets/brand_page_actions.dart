...
class BrandPageActions extends StatelessWidget {
  const BrandPageActions({
    this.contacts = const [],
    super.key,
    this.onFollow,
    this.onUnfollow,
  ...
  /// Current user brand or not.
  final bool my;

  /// If this brand is blocked or not.
  final bool blocked;

  /// If this brand is followed or not.
  final bool followed;

  /// On follow brand callback.
  final Function()? onFollow;

  /// On unfollow brand callback.
  ...
  Widget _buildMyBrandButton(BuildContext context) {
    return _buildChangeButton(context);
  }

  Widget _buildStrangeUserBrandButton(BuildContext context) {
    if (followed) {
  ...
  Widget _buildContent(BuildContext context) {
    return PaddedContent(
      child: Row(
        ...
        children: [
          if (my) _buildMyBrandButton(context) else _buildStrangeUserBrandButton(context),
