...
class BrandPageAbout extends StatefulWidget {
  const BrandPageAbout({
    super.key,
    this.about,
  ...
  @override
  State<BrandPageAbout> createState() => _BrandPageAboutState();
}

class _BrandPageAboutState extends State<BrandPageAbout> {
