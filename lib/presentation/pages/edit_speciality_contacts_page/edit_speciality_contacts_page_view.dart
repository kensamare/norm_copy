...
class EditSpecialityContactsPageView extends StatelessWidget {
  const EditSpecialityContactsPageView({super.key});
  ...
  Widget _buildContacts(BuildContext context) {
    return Observer(
      builder: (context) {
        ...
        if (state.speciality.contacts.isEmpty) {
        ...
        return ListView.separated(
          ...
          itemBuilder: (context, index) {
            final Contact contact = state.speciality.contacts.elementAt(index);
          ...
          itemCount: state.speciality.contacts.length,
